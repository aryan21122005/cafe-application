    ...
    <div className="min-h-screen bg-[#EDE4DA] text-slate-900">
      <div className="mx-auto max-w-5xl px-6 py-10">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs text-slate-500">Chef Dashboard</div>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-black/10 bg-white/70 p-5">
            ...
            <div className="mt-2 text-sm text-slate-600">See incoming orders and mark items as prepared.</div>
          </div>
          <div className="rounded-2xl border border-black/10 bg-white/70 p-5">
            <div className="text-sm font-semibold">Prep list</div>
            <div className="mt-2 text-sm text-slate-600">Ingredients, stock alerts, and prep reminders.</div>
          </div>
        </div>
      </div>
    </div>
